...
public class RegisterPageTest extends BaseTest {
    ...
    public void  VerifyThatUserShouldCreateAccountSuccessfully(){
        ...
        //   Enter firstname
        registerPage.enterFirstName("Smith");
        //   Enter lastname
        ...
        //   Enter email
        registerPage.enterEmail("naren123@gmail.com");
        //   Enter password
        registerPage.enterPassword("narenl12");
        //   Enter Confirm Password
        registerPage.enterConfirmPassword("narenl12");
        //   Click on "REGISTER" button
        registerPage.clickOnRegisterButton();
